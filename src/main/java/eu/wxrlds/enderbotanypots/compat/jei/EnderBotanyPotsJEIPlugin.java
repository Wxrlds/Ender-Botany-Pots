...
public class EnderBotanyPotsJEIPlugin implements IModPlugin {
    ...
    public ResourceLocation getPluginUid() {
        return new ResourceLocation(EnderBotanyPots.MOD_ID, "jei");
    }
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        registration.addRecipeCatalyst(
                ...
                new ResourceLocation("botanypots", "soil"));
    }
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addIngredientInfo(
                new ItemStack(EnderBotanyPots.ENDER_BOTANY_POT.get()),
                VanillaTypes.ITEM,
                new TranslationTextComponent("enderbotanypots.jei.description")
        );
    }
}
